...
const provider = pact({
    consumer: 'ComisionesService', // current service at hand, it makes it easier to know who would be broken by the change in the provider when we test the contract. 
    provider: 'ResearchersService', // required, so we know who will need to verify the pact
