...
const provider = pact({
    consumer: 'Grupo6', // current service at hand, it makes it easier to know who would be broken by the change in the provider when we test the contract. 
    provider: 'Grupo1', // required, so we know who will need to verify the pact
